                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" wire:model="tanggal_sidak"
                            class="form-control <?php $__errorArgs = ['tanggal_sidak'];
...
unset($__errorArgs, $__bag); ?>">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tanggal_sidak'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['lokasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="instansi_dikunjungi"
                            class="form-control <?php $__errorArgs = ['instansi_dikunjungi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['instansi_dikunjungi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="jenis_layanan_diamati"
                            class="form-control <?php $__errorArgs = ['jenis_layanan_diamati'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jenis_layanan_diamati'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="mb-3">
                    ...
                    <textarea wire:model="tim_pelaksana"
                        class="form-control <?php $__errorArgs = ['tim_pelaksana'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tim_pelaksana'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" wire:model="jumlah_wawancara_pengguna"
                            class="form-control <?php $__errorArgs = ['jumlah_wawancara_pengguna'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" min="0">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jumlah_wawancara_pengguna'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" wire:model="jumlah_wawancara_petugas"
                            class="form-control <?php $__errorArgs = ['jumlah_wawancara_petugas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" min="0">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jumlah_wawancara_petugas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_aksesibilitas"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_aksesibilitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_aksesibilitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_non_diskriminasi"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_non_diskriminasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_non_diskriminasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_transparansi"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_transparansi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_transparansi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_kualitas"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_kualitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_kualitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_perlakuan"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_perlakuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_perlakuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea wire:model="temuan_khusus_mekanisme_pengaduan"
                            class="form-control <?php $__errorArgs = ['temuan_khusus_mekanisme_pengaduan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['temuan_khusus_mekanisme_pengaduan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="mb-3">
                    <textarea wire:model="analisis_umum"
                        class="form-control <?php $__errorArgs = ['analisis_umum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="5"
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['analisis_umum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
</script><?php /**PATH D:\Kuliah\Kerja Praktek\KOMNASHAM\resources\views/livewire/create-report-form.blade.php ENDPATH**/ ?>