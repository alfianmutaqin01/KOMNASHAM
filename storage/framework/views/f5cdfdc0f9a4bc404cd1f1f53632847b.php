...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Jabatan:</td>
            <td><?php echo e($activityReport->user->roles->pluck('name')->first() ? ucfirst($activityReport->user->roles->pluck('name')->first()) : 'N/A'); ?></td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo e($activityReport->tanggal_mulai->translatedFormat('d F Y H:i')); ?> - <?php echo e($activityReport->tanggal_selesai->translatedFormat('d F Y H:i')); ?></td>
        </tr>
        <tr>
