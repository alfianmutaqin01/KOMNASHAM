...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($nomor_surat_terakhir); ?>" readonly>
                </div>
                <div class="col-md-6">
            ...
            <div class="text-end">
                <button type="button" wire:click="saveLetter(false)" class="btn btn-outline-warning me-2">Simpan
                    Draf</button>
                <button type="button" wire:click="saveLetter(true)" class="btn btn-outline-primary">Simpan dan
                    Cetak</button>
            </div>
        </form>
    </div>
</div>
</div><?php /**PATH D:\Kuliah\Kerja Praktek\KOMNASHAM\resources\views/livewire/create-assignment-letter-form.blade.php ENDPATH**/ ?>