        ...
        <div class="p-3">
            <div class="d-flex align-items-start mb-3">
                <a href="#" class="status-indicator-container me-3">
                    <img src="{{ asset('limitless4.0/assets/images/demo/users/face1.jpg') }}"
                        class="w-40px h-40px rounded-pill" alt="">
                    <span class="status-indicator bg-success"></span>
                </a>
                <div class="flex-fill">
                    <a href="#" class="fw-semibold">{{ Auth::user()->name }}</a> telah menyelesaikan verifikasi
            ...
            <div class="d-flex align-items-start mb-3">
                <a href="#" class="status-indicator-container me-3">
                    <img src="{{ asset('limitless4.0/assets/images/demo/users/face3.jpg') }}"
                        class="w-40px h-40px rounded-pill" alt="">
